...
export default function BookingModal() {
    ...
    const allowedCompanies = companies.filter(
        company => allowedStores.length === 0 || allowedStores.includes(company.id)
    );
                ...
                <div className="booking-modal">
                    <div className="booking-sidebar" onClick={(e) => e.stopPropagation()}>
                        <button
                            ...
                            style={{ position: 'absolute', top: '10px', right: '30px', background: 'none', border: 'none', padding: '0', cursor: 'pointer' }}
                            aria-label="Cerrar"
                        >
                        ...
                        <div className="booking-sidebar-content">
                            ...
                            {confirmationMessage ? (
                                ...
                                <>
                                    ...
                                    {loadingStores ? (
                                        <div style={{ display: 'flex', justifyContent: 'center', padding: '1rem' }}>Cargando...</div>
                                        ...
                                        <>
                                            ...
                                            {selectedCity && branchesByCity[selectedCity].map(company => (
                                                <button
                                                    key={company.id}
                                                    onClick={() => handleDirectCompanySelect(company.id)}
                                ...
                                <>
                                    {selectedCompany && !selectedTime && (
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '1rem' }}>
                                            <button onClick={() => setSelectedCompany(null)} style={{ fontSize: '1.5rem', background: 'none', border: 'none' }}>←</button>
